...
| --- | --- | --- | --- |
| Markdown | GitHub Flavored Markdown (GFM) | ✅ | Mojo platform pipeline: stable heading IDs, tables, task lists, autolinks, fenced code blocks, strikethrough, and footnotes |
